"""File to host a modified unet model with extra filers."""
from keras import Input, Model
from keras import layers as keras_layers


def get_filter_model(img_size: tuple = (512, 512), num_classes: int = 2) -> Model:
    ...
    x = keras_layers.Conv2D(64, 3, strides=2, padding="same")(inputs)
